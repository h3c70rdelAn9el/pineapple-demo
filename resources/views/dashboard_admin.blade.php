<x-app-layout>
    ...
    {{-- Quick Admin Actions --}}
    <div class="flex flex-row items-center justify-center max-w-6xl px-4 py-2 mx-auto mt-2 space-x-4 ml-14">
        <a href="{{ route('admin.broadcast-message') }}" 
           class="px-3 py-1 text-sm font-medium text-white transition duration-200 bg-indigo-600 border border-indigo-600 rounded-md hover:bg-indigo-700">
            📢 Broadcast Message
        </a>
        <a href="/messages" 
           class="px-3 py-1 text-sm font-medium text-indigo-600 transition duration-200 bg-white border border-indigo-600 rounded-md hover:bg-indigo-50">
            💬 Open Messenger
        </a>
    </div>
