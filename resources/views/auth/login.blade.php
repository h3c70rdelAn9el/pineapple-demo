<x-guest-layout>
    <x-jet-authentication-card>
        <x-slot name="logo">
            <img src="/pineapple-logo-horizontal-300x120.png" alt="logo" class="h-20 pt-3 bg-transparent">
        </x-slot>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="flex items-center justify-end mt-4">
                @if (Route::has('password.request'))
                    <a class="text-sm text-gray-600 underline hover:text-blue-500" href="{{ route('password.request') }}">
