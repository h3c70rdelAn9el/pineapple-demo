<div class="p-2 pb-12 m-2 bg-blue-100 rounded-md shadow-sm md:w-full overflow-y-auto border-2  border-purple-300">
    ...
    <div class="flex flex-col w-full p-2 m-2 mx-auto overflow-x-hidden font-normal h-full">
        {{ $content }}
    </div>
</div>
