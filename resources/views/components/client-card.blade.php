<a href="{{ route('clients.show', $client->id) }}"
    ...
    class="relative flex flex-col justify-between p-2 m-2 transition-all duration-200 ease-in bg-blue-200 border border-blue-200 rounded-lg shadow-md min-h-content shadow-blue-100 hover:border hover:border-blue-500 hover:shadow-lg">
